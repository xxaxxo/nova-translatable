...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        Nova.$on('change-tab', function (_ref) {
            var locale = _ref.locale,
                initiatorElement = _ref.initiatorElement;

            if (initiatorElement != _this) {
                _this.changeTab(locale, false);
            }
        });
        Nova.$on('field-hookup-change', function (_ref2) {
            var hookupField = _ref2.hookupField,
                initiatorElement = _ref2.initiatorElement,
    ...
    methods: {
        ...
        changeTab: function changeTab(locale) {
            ...
            var emitChangedTab = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
          ...
          ? _c("input", {
              ...
              on: {
                ...
                keyup: function($event) {
                  _vm.handleInputKeyUp(_vm.field.hookup, _vm.currentLocale)
                },
                input: function($event) {
                  if ($event.target.composing) {
                    return
